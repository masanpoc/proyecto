        ...
        <footer className='footer'>
          ...
          <div className='social-media'>
            ...
            <li className='facebook'>
              <a href='https://www.facebook.com/TheEUYO/' target='blank' className='facebook-link'>
            ...
            <li className='instagram'>
              <a href='https://www.instagram.com/marioscp1998/' target='blank' className='instagram-link'>
